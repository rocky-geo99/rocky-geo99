...
class Ui_MainWindow(object):  
    ...
    def plotw1t1(self,well1,well1df,seis_dat,repl_vel,well1df_tdom,welltopsdf):
        ...
        #if there is data in well tops for well 1
        if not welltopsdf.empty:
            print("displaying tops")
            # for each row, containing: Tops_Name,Tops_Depth,Top_Color
            Topsdfvalues = welltopsdf.values
            #print(Topsdfvalues,len(Topsdfvalues))
            for i in Topsdfvalues:
                Top_Name = i[0]
                Top_Depth = i[1]
                pencolor = i[2]
